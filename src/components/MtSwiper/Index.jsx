...
import { View,Swiper,SwiperItem,Navigator,Image } from "@tarojs/components";
import "./index.less";
...
class Index extends Component {
    ...
    render(){
        ...
        return <View className="mt_swiper">
            <Swiper className="swiper" autoplay={true} indicator-dots={true}>
                { elements }
            </Swiper>
        </View>
    }
